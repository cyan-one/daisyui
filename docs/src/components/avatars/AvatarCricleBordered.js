...
function AvatarCricleBordered() {
  return (
    <div>
      ...
      <div class="avatar">
        <div class="mb-8 rounded-full w-16 h-16 ring ring-primary ring-offset-base-100 ring-offset-2">
          <img src="https://i.pravatar.cc/500?img=32"/>
        </div>
      </div> 
      <div class="avatar">
        <div class="mb-8 rounded-full w-10 h-10 ring ring-primary ring-offset-base-100 ring-offset-2">
          <img src="https://i.pravatar.cc/500?img=32"/>
        </div>
      </div>
    </div>
